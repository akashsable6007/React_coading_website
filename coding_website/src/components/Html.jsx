    ...
    <>
      <div className="html-container">
        <div className="html-right-box">
          <img
            src={htmlimg}
            className="html-img animate__animated animate__zoomInDown"
          />
          ...
          <div className="htmlcontent">
            <div className="html-first-video">
              ...
              <iframe
                width="500px"
                height="200px"
                src="https://www.youtube.com/embed/HcOc7P5BMi4?si=_9N7o1lAWouVJCl9"
              ...
              <p>
                ...
                availabel on youtube channel name Apna College by shradha
                Khapra.{" "}
              </p>
            </div>
          </div>
          <div className="htmlcontent">
            <div className="html-seconde-video">
              ...
              <iframe
                width="500px"
                height="200px"
                src="https://www.youtube.com/embed/rklidcZ-aLU?si=ndV9rFxYD2XXP-D-"
                title="YouTube video player"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                allowfullscreen
              ...
              <p>
                {" "}
                This video is availabel on Kg coading by Prashant sir. This is
                also good video to learn Html from scratch.{" "}
              </p>
            </div>
            <div className="html-third-video">
              ...
              <iframe
                width="500"
                height="200"
                src="https://www.youtube.com/embed/-mWTE75dBVo?si=F5vdY4iuwBSX1qdD"
                title="YouTube video player"
                frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                allowfullscreen
              ...
              <p>
                {" "}
                From this project you will understand the full html concept this
                video is taken from coding shuttle by anuj bhayya.{" "}
              </p>
            </div>
          </div>
        </div>
